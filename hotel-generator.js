...
const createHotels = () => {
  ...
  const name = ['Castle Black Hostel', 'Vader Hotel', 'Anakin SkyHotel', 'Hotel Rivendel', 'Hotel Isengard', 'Hotel Minas Tirith', 'Hotel Firefly', 'Jawa Hotel', 'Inn to the Millenum Falcon', "Jabbas's Palace"]
