...
//-------------------------
  ...
  // NORMA FRONTEND NOT WORKING
    ...
    app.patch('/api/hotels/:id', (req, res) => {
        const hotelID = req.params.id;
        const has_wifi = req.body.attributes.has_wifi;
        const has_parking = req.body.attributes.has_parking;
        const has_pets = req.body.attributes.has_pets;
        const has_restaurant = req.body.attributes.has_restaurant;
        const has_bar = req.body.attributes.has_bar;
        const has_swimming_pool = req.body.attributes.has_swimming_pool;
        const has_air_condition = req.body.attributes.has_air_conditioning;
        const has_gym = req.body.attributes.has_gym;
        const name = req.body.attributes.name;
        const meal_plan = req.body.attributes.meal_plan;
        const stars = req.body.attributes.stars;
        const location = req.body.attributes.location;
        const main_image_src = req.body.attributes.main_image_src;
        let response = {data:{}};
